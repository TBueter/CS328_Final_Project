...
#ifndef  SYMMETRICALMATRIX_H
#define  SYMMETRICALMATRIX_H
...
////////////////////////////////////////////////////////////////
template <class T>
class SymmetricalMatrix : public Base_Matrix<T>
{
    public:
        ////////////////////////////////////////////////////////////////
        ///  Func:   SymmetricalMatrix (Default)
        ///  Brief:  Default constructor for class. Creates an empty 
        ///          Matrix.
        ///  Pre:    None
        ///  Post:   An empty Symmetrical Matrix is defined with size equal to 
        ///          zero and no memory allocated.
        ////////////////////////////////////////////////////////////////
        SymmetricalMatrix();
        
        ////////////////////////////////////////////////////////////////
        ///  Func:   SymmetricalMatrix
        ///  Brief:  Primary constructor for class. Creates a n-by-n 
        ///          Symmetrical Matrix with components.
        ///  Pre:    None
        ///  Post:   A Symmetrical Matrix is defined with 'n' rows and columns.
        ...
        ////////////////////////////////////////////////////////////////
        SymmetricalMatrix(const unsigned int order);
        ...
        ///  Brief:  Copy constructor for class. Creates a new Symmetrical Matrix 
        ///          that is a clone of the given Symmetrical Matrix.
        ///  Pre:    None
        ///  Post:   A Symmetrical Matrix is defined with the same order as the 
        ///          source Symmetrical Matrix and with copies
        ///          of the same components. 
        ///  Param:  src - Another instance of a Symmetrical Matrix to be copied.
        ////////////////////////////////////////////////////////////////
        SymmetricalMatrix(const SymmetricalMatrix<T>& src);
        ...
        ///          same number of elements. An error will be thrown
        ///          if any differ from the size of the first set.
        ///          A Symmetrical Matrix is defined with 'm' rows and 'n' columns.
        ...
        ///          used to populate the Symmetrical Matrix.
        ////////////////////////////////////////////////////////////////
        SymmetricalMatrix(const initializer_list< initializer_list<T> > list);
        ...
        ///          read access to the components of the Symmetrical Matrix. 
        ///  Pre:    row < m_order
        ///  Pre:    col < m_order
        ///  Post:   None
        ///  Param:  row - Non-negative index value for a Symmetrical Matrix 
        ///          row location.
        ///  Param:  col - Non-negative index value for a Symmetrical Matrix 
        ///          column location.
        ...
        ///     Return: Returns the number of rows of the matrix.
        ////////////////////////////////////////////////////////////////
        virtual MatrixType getType() const {return SYMMETRICAL;}
        ...
        ////////////////////////////////////////////////////////////////   
        SymmetricalMatrix<T>& operator=(const Base_Matrix<T>& rhs);
        ...
        ///          Otherwise, component values of *this are summed
        ///          with those of rhs.
        ///  Param:  rhs - Instance of a Symmetrical Matrix.
        ///  Return: Returns self.
        //////////////////////////////////////////////////////////////// 
        SymmetricalMatrix<T>& operator+=(const SymmetricalMatrix<T>& rhs);
        ...
        ///  Return: Returns the new Symmetrical Matrix instance.
        ////////////////////////////////////////////////////////////////
        SymmetricalMatrix<T>  operator-() const;
        ...
        ///  Brief:  Overloaded multiplication operator for class. 
        ///          Scales the component values of the Symmetrical Matrix by the
        ///          scalar.
        ///  Pre:    T = T (assignment) must be defined.
        ///          T * T (multiplication) must be defined with result
        ///          T.
        ...
        ///  Param:  scalar - T instance for the componets of the Symmetrical 
        ///          Matrix to be multiplied by.
        ///  Return: Returns the new Symmetrical Matrix instance.
        ////////////////////////////////////////////////////////////////
        SymmetricalMatrix<T>  operator*(const T scalar) const;
        
        ////////////////////////////////////////////////////////////////
        ///  Func:   *= (Urnary, Matrix scaling assignment)
        ///  Brief:  Overloaded multiplication assigment operator for  
        ///          class. Scales the component values of the Symmetrical Matrix 
        ///          by the scalar. 
        ...
        ///  Return: Returns self.
        ////////////////////////////////////////////////////////////////
        SymmetricalMatrix<T>& operator*=(const T scalar);
        
        ////////////////////////////////////////////////////////////////
        ///  Func:   * (Matrix-Vector Multiplication)
        ///  Brief:  Overloaded multiplication operator for class.
        ///          Performs multiplication on a Symmetrical Matrix and Vector
        ///          instance.
        ///  Pre:    T = T (assignment) must be defined.
        ///          T += T (addition) must be defined.
        ///          T * T (multiplication) must be defined with result
        ...
        ////////////////////////////////////////////////////////////////
        ///  Func:   Transpose
        ///  Brief:  Takes the transpose of the Symmetrical Matrix. 
        ///  Pre:    T = T (assignment) must be defined.
        ///  Post:   None.
        ///  Return: Returns a new Matrix instance that is a transpose 
        ///          of the Symmetrical Matrix.
        ////////////////////////////////////////////////////////////////
        Matrix<T> Transpose() const;
        
        ////////////////////////////////////////////////////////////////
        ///  Func:   SetAll
        ///  Brief:  Sets all the elements of the Symmetrical Matrix to the given
        ///          value. 
        ///  Pre:    T = T (assignment) must be defined.
        ...
        ////////////////////////////////////////////////////////////////
        ///  Func:   Zero
        ///  Brief:  Sets all the elements of the Symmetrical Matrix to zero. 
        ...
        ////////////////////////////////////////////////////////////////
        ///  Func:   getOrder
        ///  Brief:  Gets the order (# of rows-columns) of the Symmetrical Matrix
        ///  Return: Returns order of the Symmetrical Matrix.
        ////////////////////////////////////////////////////////////////
        ...
        ///          multiplied by.
        ///  Param:  src - Instance of a Symmetrical Matrix.
        ///  Return: Returns the new Symmetrical Matrix instance.
        ////////////////////////////////////////////////////////////////
        friend SymmetricalMatrix<T> operator*(const T scalar, const SymmetricalMatrix<T>& src)
        {
            return (src * scalar);
        }
        ...
        ///  Post:   None.
        ///  Param:  lhs - Instance of a Symmetrical Matrix.
        ///  Param:  rhs - Instance of an abstract Base_Matrix.
        ///  Return: Returns false if unequal row or column sizes or
        ///          unequal elements. Returns true if all elements are
        ///          found to be equal.
        ////////////////////////////////////////////////////////////////     
        friend bool operator==(const SymmetricalMatrix<T>& lhs, const Base_Matrix<T>& rhs)
        {
        ...
        ///          found to be equal.
        ////////////////////////////////////////////////////////////////
        friend bool operator==(const SymmetricalMatrix<T>& lhs, const SymmetricalMatrix<T>& rhs)
        {
        ...
        ///  Pre:    None
        ///  Post:   Prints out the Symmetrical Matrix's component values in this
        ///          format: | x_11 x_12 ... x_1n |
        ///                    ...
        ///                  | x_n1 x_n2 ... x_nn |
        ///  Param:  rhs - Reference to Symmetrical Matrix instance.
        ///  Return: Returns output stream.
        ////////////////////////////////////////////////////////////////
        friend ostream& operator<<(ostream& out, const SymmetricalMatrix<T>& rhs)
        {
            stringstream ss;
            ss.precision(3);
        ...
        ///  Pre:    None.
        ///  Post:   A new Symmetrical Matrix instance is created given user 
        ///          input. rhs is set to be equal to the new instance.
        ///  Param:  rhs - Reference to Symmetrical Matrix instance.
        ///  Return: Returns input stream.
        ////////////////////////////////////////////////////////////////
        friend istream& operator>>(istream& in, SymmetricalMatrix<T>& rhs)
        {
    ...
    private:
        ...
        ///////////////////////////////////////////////////////////////
        ///  Func:   copy
        ///  Brief:  Performs a deep copy of the given Symmetrical Matrix
        ...
        ////////////////////////////////////////////////////////////////  
        void copy(const SymmetricalMatrix<T>& src);
        
};

#include "SymmetricalMatrix.hpp"
#endif //SYMMETRICALMATRIX_H
