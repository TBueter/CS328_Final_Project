...
///
///        Upper Triangular Matrix is appreviated: UT Matrix 
////////////////////////////////////////////////////////////////
template <class T>
class UpperTriangularMatrix : public Base_Matrix<T>
{
    public:
        ////////////////////////////////////////////////////////////////
        ///  Func:   UpperTriangularMatrix (Default)
        ///  Brief:  Default constructor for class. Creates an empty 
        ///          Matrix.
        ///  Pre:    None
        ///  Post:   An empty UT Matrix is defined with size equal to 
        ...
        ///          UT Matrix with components.
        ///  Pre:    None
        ///  Post:   A UT Matrix is defined with 'n' rows and columns.
        ...
        ////////////////////////////////////////////////////////////////
        UpperTriangularMatrix(const unsigned int order);
        ...
        ////////////////////////////////////////////////////////////////
        UpperTriangularMatrix(const unsigned int order, const T value);
        
        ////////////////////////////////////////////////////////////////
        ///  Func:   UpperTriangularMatrix (Copy)
        ///  Brief:  Copy constructor for class. Creates a new UT Matrix 
        ///          that is a clone of the given UT Matrix.
        ///  Pre:    None
        ///  Post:   A UT Matrix is defined with the same order as the 
        ///          source UT Matrix and with copies
        ///          of the same components. 
        ///  Param:  src - Another instance of a UT Matrix to be copied.
        ////////////////////////////////////////////////////////////////
        ...
        ///          same number of elements. An error will be thrown
        ///          if any differ from the size of the first set.
        ///          A UT Matrix is defined with 'm' rows and 'n' columns.
        ...
        ///          used to populate the UT Matrix.
        ////////////////////////////////////////////////////////////////
        UpperTriangularMatrix(const initializer_list< initializer_list<T> > list);
        ...
        ///          read access to the components of the UT Matrix. 
        ///  Pre:    row < m_order
        ///  Pre:    col < m_order
        ///  Post:   None
        ///  Param:  row - Non-negative index value for a UT Matrix 
        ///          row location.
        ///  Param:  col - Non-negative index value for a UT Matrix 
        ///          column location.
        ...
        ///     Return: Returns the number of rows of the matrix.
        ////////////////////////////////////////////////////////////////
        virtual MatrixType getType() const {return UPPERTRIANGULAR;}
        ...
        ////////////////////////////////////////////////////////////////   
        UpperTriangularMatrix<T>& operator=(const Base_Matrix<T>& rhs);
        ...
        ///          Otherwise, component values of *this are summed
        ///          with those of rhs.
        ///  Param:  rhs - Instance of a UT Matrix.
        ///  Return: Returns self.
        //////////////////////////////////////////////////////////////// 
        UpperTriangularMatrix<T>& operator+=(const UpperTriangularMatrix<T>& rhs);
        ...
        ///          result T.
        ///  Post:   None
        ///  Return: Returns the new UT Matrix instance.
        ////////////////////////////////////////////////////////////////
        ...
        ///  Brief:  Overloaded multiplication operator for class. 
        ///          Scales the component values of the UT Matrix by the
        ///          scalar.
        ///  Pre:    T = T (assignment) must be defined.
        ///          T * T (multiplication) must be defined with result
        ///          T.
        ...
        ///  Param:  scalar - T instance for the componets of the UT 
        ///          Matrix to be multiplied by.
        ///  Return: Returns the new UT Matrix instance.
        ////////////////////////////////////////////////////////////////
        UpperTriangularMatrix<T>  operator*(const T scalar) const;
        
        ////////////////////////////////////////////////////////////////
        ///  Func:   *= (Urnary, Matrix scaling assignment)
        ///  Brief:  Overloaded multiplication assigment operator for  
        ///          class. Scales the component values of the UT Matrix 
        ///          by the scalar. 
        ...
        ///  Return: Returns self.
        ////////////////////////////////////////////////////////////////
        UpperTriangularMatrix<T>& operator*=(const T scalar);
        
        ////////////////////////////////////////////////////////////////
        ///  Func:   * (Matrix-Vector Multiplication)
        ///  Brief:  Overloaded multiplication operator for class.
        ///          Performs multiplication on a UT Matrix and Vector
        ///          instance.
        ///  Pre:    T = T (assignment) must be defined.
        ///          T += T (addition) must be defined.
        ///          T * T (multiplication) must be defined with result
        ...
        ////////////////////////////////////////////////////////////////
        ///  Func:   Transpose
        ///  Brief:  Takes the transpose of the UT Matrix. 
        ///  Pre:    T = T (assignment) must be defined.
        ///  Post:   None.
        ...
        ////////////////////////////////////////////////////////////////
        ///  Func:   SetAll
        ///  Brief:  Sets all the elements of the UT Matrix to the given
        ///          value. 
        ///  Pre:    T = T (assignment) must be defined.
        ...
        ////////////////////////////////////////////////////////////////
        ///  Func:   Zero
        ///  Brief:  Sets all the elements of the UT Matrix to zero. 
        ...
        ////////////////////////////////////////////////////////////////
        ///  Func:   Resize
        ///  Brief:  Deletes the data in the UT Matrix and resizes it.
        ...
        ////////////////////////////////////////////////////////////////
        ///  Func:   getOrder
        ///  Brief:  Gets the order (# of rows-columns) of the UT Matrix
        ///  Return: Returns order of the UT Matrix.
        ////////////////////////////////////////////////////////////////
        ...
        ///          multiplied by.
        ///  Param:  src - Instance of a UT Matrix.
        ///  Return: Returns the new UT Matrix instance.
        ////////////////////////////////////////////////////////////////
        friend UpperTriangularMatrix<T> operator*(const T scalar, const UpperTriangularMatrix<T>& src)
        {
            return (src * scalar);
        }
        ...
        ///  Post:   None.
        ///  Param:  lhs - Instance of a UT Matrix.
        ///  Param:  rhs - Instance of an abstract Base_Matrix.
        ///  Return: Returns false if unequal row or column sizes or
        ///          unequal elements. Returns true if all elements are
        ///          found to be equal.
        ////////////////////////////////////////////////////////////////     
        friend bool operator==(const UpperTriangularMatrix<T>& lhs, const Base_Matrix<T>& rhs)
        {
        ...
        ///          found to be equal.
        ////////////////////////////////////////////////////////////////
        friend bool operator==(const UpperTriangularMatrix<T>& lhs, const UpperTriangularMatrix<T>& rhs)
        {
        ...
        ///  Pre:    None
        ///  Post:   Prints out the UT Matrix's component values in this
        ///          format: | x_11 x_12 ... x_1n |
        ///                    ...
        ///                  | x_n1 x_n2 ... x_nn |
        ///  Param:  rhs - Reference to UT Matrix instance.
        ///  Return: Returns output stream.
        ////////////////////////////////////////////////////////////////
        friend ostream& operator<<(ostream& out, const UpperTriangularMatrix<T>& rhs)
        {
            stringstream ss;
            ss.precision(3);
        ...
        ///  Pre:    None.
        ///  Post:   A new UT Matrix instance is created given user 
        ///          input. rhs is set to be equal to the new instance.
        ///  Param:  rhs - Reference to UT Matrix instance.
        ///  Return: Returns input stream.
        ////////////////////////////////////////////////////////////////
        friend istream& operator>>(istream& in, UpperTriangularMatrix<T>& rhs)
        {
    ...
    private:
        ...
        ///////////////////////////////////////////////////////////////
        ///  Func:   copy
        ///  Brief:  Performs a deep copy of the given UT Matrix
        ...
        ////////////////////////////////////////////////////////////////  
        void copy(const UpperTriangularMatrix<T>& src);
