...
////////////////////////////////////////////////////////////////
template <class T>
class TridiagonalMatrix : public Base_Matrix<T>
{
    public:
        ////////////////////////////////////////////////////////////////
        ///  Func:   TridiagonalMatrix (Default)
        ///  Brief:  Default constructor for class. Creates an empty 
        ///          Matrix.
        ///  Pre:    None
        ///  Post:   An empty Tridiagonal Matrix is defined with size
        ///          equal to zero and no memory allocated.
        ////////////////////////////////////////////////////////////////
        TridiagonalMatrix();
        
        ////////////////////////////////////////////////////////////////
        ///  Func:   TridiagonalMatrix
        ///  Brief:  Primary constructor for class. Creates a n-by-n 
        ///          Tridiagonal Matrix with components.
        ///  Pre:    None
        ///  Post:   A Tridiagonal Matrix is defined with 'n' rows and
        ///          columns.
        ...
        ////////////////////////////////////////////////////////////////
        TridiagonalMatrix(const unsigned int order);
        ...
        ////////////////////////////////////////////////////////////////
        TridiagonalMatrix(const unsigned int order, const T value);
        
        ////////////////////////////////////////////////////////////////
        ///  Func:   TridiagonalMatrix (Copy)
        ///  Brief:  Copy constructor for class. Creates a new 
        ///          Tridiagonal Matrix that is a clone of the given    
        ///          Tridiagonal Matrix.
        ///  Pre:    None
        ///  Post:   A Tridiagonal Matrix is defined with the same order
        ///          as the source Tridiagonal Matrix and with copies
        ///          of the same components. 
        ///  Param:  src - Another instance of a Tridiagonal Matrix to 
        ///          be copied.
        ////////////////////////////////////////////////////////////////
        TridiagonalMatrix(const TridiagonalMatrix<T>& src);
        ...
        ///          same number of elements. An error will be thrown
        ///          if any differ from the size of the first set.
        ///          A Tridiagonal Matrix is defined with 'm' rows and 
        ///          'n' columns.
        ...
        ///          used to populate the Tridiagonal Matrix.
        ////////////////////////////////////////////////////////////////
        TridiagonalMatrix(const initializer_list< initializer_list<T> > list);
        ...
        ///          read access to the components of the Tridiagonal 
        ///          Matrix. 
        ///  Pre:    row < m_rows
        ///  Pre:    col < m_cols
        ///  Post:   None
        ///  Param:  row - Non-negative index value for a Tridiagonal 
        ///          Matrix row location.
        ///  Param:  col - Non-negative index value for a Tridiagonal 
        ...
        ////////////////////////////////////////////////////////////////
        ///  Func:   Resize
        ///  Brief:  Deletes the data in the Tridiagonal Matrix and 
        ///          resizes it.
        ...
        ///     Return: Returns the number of rows of the matrix.
        ////////////////////////////////////////////////////////////////
        virtual MatrixType getType() const {return TRIDIAGONAL;}
        ...
        ////////////////////////////////////////////////////////////////   
        TridiagonalMatrix<T>& operator=(const Base_Matrix<T>& rhs);
        ...
        ///          Otherwise, component values of *this are summed
        ///          with those of rhs.
        ///  Param:  rhs - Instance of a Tridiagonal Matrix.
        ///  Return: Returns self.
        //////////////////////////////////////////////////////////////// 
        TridiagonalMatrix<T>& operator+=(const TridiagonalMatrix<T>& rhs);
        ...
        ///          result T.
        ///  Post:   None
        ///  Return: Returns the new Tridiagonal Matrix instance.
        ////////////////////////////////////////////////////////////////
        ...
        ///  Brief:  Overloaded multiplication operator for class. 
        ///          Scales the component values of the Tridiagonal 
        ...
        ///          Tridiagonal Matrix to be multiplied by.
        ///  Return: Returns the new Tridiagonal Matrix instance.
        ////////////////////////////////////////////////////////////////
        TridiagonalMatrix<T>  operator*(const T scalar) const;
        
        ////////////////////////////////////////////////////////////////
        ///  Func:   *= (Urnary, Matrix scaling assignment)
        ///  Brief:  Overloaded multiplication assigment operator for  
        ///          class. Scales the component values of the 
        ///          Tridiagonal Matrix by the scalar. 
        ...
        ///  Return: Returns self.
        ////////////////////////////////////////////////////////////////
        TridiagonalMatrix<T>& operator*=(const T scalar);
        
        ////////////////////////////////////////////////////////////////
        ///  Func:   * (Matrix-Vector Multiplication)
        ///  Brief:  Overloaded multiplication operator for class.
        ///          Performs multiplication on a Tridiagonal Matrix and 
        ///          Vector instance.
        ///  Pre:    T = T (assignment) must be defined.
        ///          T += T (addition) must be defined.
        ///          T * T (multiplication) must be defined with result
        ...
        ////////////////////////////////////////////////////////////////
        ///  Func:   SetAll
        ///  Brief:  Sets all the elements of the Tridiagonal Matrix to 
        ///          the given value. 
        ///  Pre:    T = T (assignment) must be defined.
        ...
        ////////////////////////////////////////////////////////////////
        ///  Func:   getOrder
        ///  Brief:  Gets the order (# of rows-columns) of the 
        ///          Tridiagonal Matrix
        ///  Return: Returns order of the Tridiagonal Matrix.
        ////////////////////////////////////////////////////////////////
        ...
        ///          multiplied by.
        ///  Param:  src - Instance of a Tridiagonal Matrix.
        ///  Return: Returns the new Tridiagonal Matrix instance.
        ////////////////////////////////////////////////////////////////
        friend TridiagonalMatrix<T> operator*(const T scalar, const TridiagonalMatrix<T>& src)
        {
            return (src * scalar);
        }
        ...
        ///  Post:   None.
        ///  Param:  lhs - Instance of a Tridiagonal Matrix.
        ///  Param:  rhs - Instance of an abstract Base_Matrix.
        ///  Return: Returns false if unequal row or column sizes or
        ///          unequal elements. Returns true if all elements are
        ///          found to be equal.
        ////////////////////////////////////////////////////////////////     
        friend bool operator==(const TridiagonalMatrix<T>& lhs, const Base_Matrix<T>& rhs)
        {
        ...
        ///  Pre:    None
        ///  Post:   Prints out the Tridiagonal Matrix's component 
        ///          values in this format: 
        ///                  | x_11 x_12 ... x_1n |
        ///                    ...
        ///                  | x_n1 x_n2 ... x_nn |
        ///  Param:  rhs - Reference to Tridiagonal Matrix instance.
        ///  Return: Returns output stream.
        ////////////////////////////////////////////////////////////////
        friend ostream& operator<<(ostream& out, const TridiagonalMatrix<T>& rhs)
        {
            stringstream ss;
            ss.precision(3);
        ...
        ///  Pre:    None.
        ///  Post:   A new Tridiagonal Matrix instance is created given 
        ///          user input. rhs is set to be equal to the new 
        ///          instance.
        ///  Param:  rhs - Reference to Tridiagonal Matrix instance.
        ///  Return: Returns input stream.
        ////////////////////////////////////////////////////////////////
        friend istream& operator>>(istream& in, TridiagonalMatrix<T>& rhs)
        {
    ...
    private:
        ...
        ///////////////////////////////////////////////////////////////
        ///  Func:   copy
        ///  Brief:  Performs a deep copy of the given Tridiagonal Matrix
        ...
        ////////////////////////////////////////////////////////////////  
        void copy(const TridiagonalMatrix<T>& src);
